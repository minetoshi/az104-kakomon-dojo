...
現行件数は `inventory.js` を中央台帳とし、`index.html` 起動時に総数・セット別・章別・おすすめ分野別を実データと照合します。不一致があればページ上にエラーを表示します。詳細は `audit/2026-09-22-count-consistency-audit.md` を参照してください。
