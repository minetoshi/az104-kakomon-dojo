...
## 結論
既存の過去問100問 + 類似問題100問に、公式学習ガイドで薄かった領域を狙った **公式範囲補強50問** を追加した。  
...
| ID/ガバナンス | Azure Policy を実装して管理する | cov-q003, cov-q004, cov-q005 | 補強済 |
...
| ID/ガバナンス | アラート、予算、Advisor でコストを管理する | s1-q031, s1-q032, s2-q025 | 既存 |
| ID/ガバナンス | 管理グループを構成する | cov-q006 | 補強済 |
| Storage | Storage firewall / VNet を構成する | cov-q008, cov-q009 | 補強済 |
| Storage | SAS を作成・使用する | s1-q035, sim-q035 | 既存 |
| Storage | Stored access policy を構成する | cov-q010 | 補強済 |
| Storage | アクセス キーを管理する | cov-q011, s1-q030 | 補強済 |
...
| Storage | ストレージ暗号化を構成する | cov-q012 | 補強済 |
| Storage | Storage Explorer / AzCopy でデータ管理 | cov-q013, cov-q014 | 補強済 |
...
| Compute | 既存 Bicep を変更する | cov-q021, cov-q022 | 補強済 |
...
| Compute | VM Scale Sets | cov-q031, cov-q032 | 補強済 |
| Compute | Azure Container Registry | cov-q033, cov-q034 | 補強済 |
...
| App Service | 証明書 / TLS | s1-q019 | 既存 |
| App Service | Custom DNS mapping | s1-q023 | 既存 |
| App Service | Backup | cov-q038 | 補強済 |
| App Service | Networking | cov-q036, cov-q037 | 補強済 |
| App Service | Deployment slots | cov-q035 | 補強済 |
| Networking | VNet / Subnet を作成・構成 | s2-q044, sim-q093 | 既存 |
| Networking | VNet peering | s2-q049, cov-q042, sim-q099 | 補強済 |
| Networking | Public IP | s1-q001 | 既存 |
| Networking | UDR | s2-q041, sim-q091 | 既存 |
| Networking | 接続トラブルシューティング | s1-q045, sim-q060 | 既存 |
| Networking | NSG / ASG | s2-q044, sim-q094, sim-q097 | 既存 |
...
| Networking | PaaS private endpoint | cov-q040, cov-q037 | 補強済 |
| Networking | Azure DNS | s1-q005, s1-q006, s1-q007 | 既存 |
| Networking | Internal/Public Load Balancer | s1-q008, s1-q009, s2-q048 | 既存 |
| Networking | Load Balancer troubleshooting | s1-q010, sim-q100 | 既存 |
| Monitor | Azure Monitor metrics を解釈 | s1-q021, s1-q044 | 既存 |
| Monitor | Azure Monitor log settings | s2-q012, sim-q062 | 既存 |
| Monitor | KQL query / analysis | s1-q047 | 既存 |
| Monitor | Alert rule / Action Group / Alert Processing Rule | s2-q011, sim-q061, cov-q044 | 補強済 |
| Monitor | Azure Monitor Insights | cov-q045 | 補強済 |
| Monitor | Network Watcher / Connection Monitor | s1-q045, cov-q046 | 補強済 |
| Backup/DR | Recovery Services vault | s2-q013, s2-q016 | 既存 |
...
| Backup/DR | Secondary region failover | cov-q049 | 補強済 |
| Backup/DR | Backup reports / alerts | cov-q050 | 補強済 |
